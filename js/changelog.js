let changelog = [
  {
    ...
    changes: ["Changed the CSS folder structure."],
  },
  {
    version: "Version 0.5.0",
    changes: ["Completely changed the documentation page.", "Minor change in the folder structure.", "Changed some CSS in the documentation page."],
  },
  {
  ...
  },
  {
    ...
    changes: ["Added new function dVarTime.", "Added new function dVarUtcFull.", "Added new function dVarUtcTime."],
  },
  {
    version: "Version 0.3.2",
    changes: ["Added new function dVarMillisecond.", "Added new function dVarUnix."],
  },
  {
    version: "Version 0.3.1",
    changes: ["Added new function dVarDay."],
  },
  {
    version: "Version 0.3.0",
    changes: [
      "Added new function dVarDate.",
      "Added new function dVarFull.",
      "Added new function dVarHour.",
      "Added new function dVarMinute.",
      "Added new function dVarMonth.",
      "Added new function dVarSecond.",
      "Added new function dVarYear.",
